...
<body class="bg-gray-100 p-6">
    ...
    <input type="text" id="searchById" placeholder="Search by ID" class="border border-gray-300 px-4 py-2 rounded-lg mr-2">
    <input type="text" id="searchByName" placeholder="Search by Name" class="border border-gray-300 px-4 py-2 rounded-lg mr-2">
        ...
        <div class="modal-content">
            ...
            <form action="input.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="text_price" id="text_price" class="w-full border border-gray-300 p-2 rounded" required>
                </div>
                <div class="mb-4">
                    <label for="text_qty" class="block text-gray-700">Product Quantity</label>
                    <input type="text" name="text_qty" id="text_qty" class="w-full border border-gray-300 p-2 rounded" required>
                </div>
                <div class="mb-4">
                    <label for="text_image" class="block text-sm font-medium text-gray-700 mb-2">Product Image</label>
                    <div id="drop-zone" class="border-2 border-dashed border-gray-300 p-6 rounded-md text-center cursor-pointer hover:border-blue-500 hover:bg-blue-50">
                        <p>Drag & drop an image here or click to select</p>
                        <input type="file" name="text_image" id="text_image" accept="image/*" class="hidden">
                        <img id="preview" class="preview-img mt-4 max-w-xs max-h-20 mx-auto" src="" alt="Image preview" style="display: none;">
                    </div>
                </div>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                    ...
                    <td class='border-b px-4 py-2 text-center'><img src='uploads/{$row['productImage']}' alt='{$row['productName']}' class='w-20 h-20 object-fit mx-auto'></td>
    ...
    <div class="modal-content">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="edit_name" id="edit_name" class="w-full border border-gray-300 p-2 rounded" required>
            </div>
            <div class="mb-4">
                <label for="edit_price" class="block text-gray-700">Product Price</label>
                <input type="text" name="edit_price" id="edit_price" class="w-full border border-gray-300 p-2 rounded" required>
            </div>
            <div class="mb-4">
                <label for="edit_qty" class="block text-gray-700">Product Quantity</label>
                <input type="text" name="edit_qty" id="edit_qty" class="w-full border border-gray-300 p-2 rounded" required>
            </div>
            <div class="drop-zone border-dashed border-2 border-gray-300 p-4 rounded mb-4 text-center cursor-pointer flex flex-col items-center" id="edit-drop-zone">
            ...
            <img id="edit-preview" class="preview-img max-w-xs mt-4 max-h-20" src="" alt="Image preview" style="display: none;">
        </div>
